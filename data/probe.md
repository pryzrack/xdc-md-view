...
This is a beginners' guide for [node-telegram-bot-api](https://github.com/yagop/node-telegram-bot-api) .
 ...
 - [Interacting with groups and channels](#Interacting+with+groups+and+channels)
...
![BothFather](telegram/botfather.webp)
...
![first message](telegram/first_message.webp)
...
![captionjpg](telegram/captionjpg.webp)
...
![keyboard](telegram/keyboard.webp)
...
![keyboards](telegram/keyboards.webp)
...
![username](telegram/usersname.webp)
...
![parse_mode](telegram/parse_mode.webp)
...
![location](telegram/location.webp)
